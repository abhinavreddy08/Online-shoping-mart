...
public class Itemframe1 extends JFrame implements ActionListener{
	ImageIcon icon;
	String name,s;
	int price,cost;
	...
	ButtonGroup bg;
	Container c;
	Itemframe1(ImageIcon icon,String name,int price){
		this.setLayout(null);
		this.icon = icon;
		this.name = name;
		this.price = price;
	    ...
	    b = new JButton(icon);
	    r1 = new JRadioButton("1 item",false);
	    r2 = new JRadioButton("2 items",false);
	    r3 = new JRadioButton("3 items",false);
	    r4 = new JRadioButton("4 items",false);
	    r5 = new JRadioButton("5 items",false);
	    bg = new ButtonGroup();
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()==back) {
			...
			if(r1.isSelected()) {
			   ...
			   Listframe.quat[Listframe.temp]="item";}
				else if(r2.isSelected()) {
					Listframe.quantity[Listframe.temp]=2;
			Listframe.quat[Listframe.temp]="items";}
