...
public class Itemframe2 extends JFrame implements ActionListener{
	ImageIcon icon;
	String name,s;
	int price,cost;
	...
	ButtonGroup bg;
	Container c;
	Itemframe2(ImageIcon icon,String name,int price){
		this.setLayout(null);
		this.icon = icon;
		this.name = name;
		this.price = price;
	    ...
	    b = new JButton(icon);
	    r1 = new JRadioButton("1 dozen",false);
	    r2 = new JRadioButton("2 dozen",false);
	    r3 = new JRadioButton("3 dozen",false);
	    r4 = new JRadioButton("4 dozen",false);
	    r5 = new JRadioButton("5 dozen",false);
	    bg = new ButtonGroup();
	...
	public void actionPerformed(ActionEvent ae) {
		if(ae.getSource()==back) {
			...
			Listframe.quat[Listframe.temp]="Dozen";}
			else if(r2.isSelected()) {
				Listframe.quantity[Listframe.temp]=2;
				Listframe.quat[Listframe.temp]="Dozens";}
